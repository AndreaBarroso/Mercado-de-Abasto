...
<div class="grocerycrud-container">
	...
	<div class="dataTablesContainer">
		<div class="float-right">
			<?php if(!$unset_add){?>
			<div class="">
			<a role="button" class="add_button" href="<?php echo $add_url?>">
				<!--<span class="ui-button-icon-primary ui-icon ui-icon-circle-plus"></span>-->
				
				<span class="float-right">Agregar<img src="https://img.icons8.com/nolan/64/plus.png" width="32" height="32"/></span>
			</a>
			</div>
			<br>
		<?php }?>
